        ...
        <Card>
          ...
          <form>
            ...
            <Form.Item label="In which neighbourhood is the property located">
              ...
              >
                <Option value="neighbourhood_cleansed_1Ο ΝΕΚΡΟΤΑΦΕΙΟ">
                  1st Cemetery
                </Option>
                <Option value="neighbourhood_cleansed_ΑΓΙΟΣ ΕΛΕΥΘΕΡΙΟΣ">
                  Agios Eleutherios
                </Option>
                <Option value="neighbourhood_cleansed_ΑΓΙΟΣ ΚΩΝΣΤΑΝΤΙΝΟΣ-ΠΛΑΤΕΙΑ ΒΑΘΗΣ">
                  Agios Konstantinos - Vathis square
                </Option>
                <Option value="neighbourhood_cleansed_ΑΓΙΟΣ ΝΙΚΟΛΑΟΣ">
                  Agios Nikolaos
                </Option>
                <Option value="neighbourhood_cleansed_ΑΚΑΔΗΜΙΑ ΠΛΑΤΩΝΟΣ">
                  Akadimia Platonos
                </Option>
                <Option value="neighbourhood_cleansed_ΑΚΡΟΠΟΛΗ">
                  Akropolis
                </Option>
                <Option value="neighbourhood_cleansed_ΑΜΠΕΛΟΚΗΠΟΙ">
                  Ampelokipi
                </Option>
                <Option value="neighbourhood_cleansed_ΑΝΩ ΚΥΨΕΛΗ">
                  Ano Kipseli
                </Option>
                <Option value="neighbourhood_cleansed_ΑΝΩ ΠΑΤΗΣΙΑ">
                  Ano Patisia
                </Option>
                <Option value="neighbourhood_cleansed_ΒΟΤΑΝΙΚΟΣ">
                  Votanikos
                </Option>
                ...
                <Option value="neighbourhood_cleansed_ΕΛΛΗΝΟΡΩΣΩΝ">
                  Ellinoroson
                </Option>
                ...
                <Option value="neighbourhood_cleansed_ΚΕΡΑΜΕΙΚΟΣ">
                  Keramikos
                </Option>
                <Option value="neighbourhood_cleansed_ΚΟΛΟΚΥΝΘΟΥ">
                  Kolokinthou
                </Option>
                <Option value="neighbourhood_cleansed_ΚΟΛΩΝΑΚΙ">
                  Kolonaki
                </Option>
                <Option value="neighbourhood_cleansed_ΚΟΛΩΝΟΣ">Kolonos</Option>
                <Option value="neighbourhood_cleansed_ΚΟΥΚΑΚΙ-ΜΑΚΡΥΓΙΑΝΝΗ">
                  Koukaki - Makrigianni
                </Option>
                <Option value="neighbourhood_cleansed_ΚΥΨΕΛΗ">Kipseli</Option>
                <Option value="neighbourhood_cleansed_ΛΥΚΑΒΗΤΤΟΣ">
                  Likavitos
                </Option>
                <Option value="neighbourhood_cleansed_ΜΟΥΣΕΙΟ-ΕΞΑΡΧΕΙΑ-ΝΕΑΠΟΛΗ">
                  Mouseio - Exarchia - Neapoli
                </Option>
                <Option value="neighbourhood_cleansed_ΝΕΑ ΚΥΨΕΛΗ">
                  Nea Kipseli
                </Option>
                <Option value="neighbourhood_cleansed_ΝΕΟΣ ΚΟΣΜΟΣ">
                  Neos Kosmos
                </Option>
                ...
                <Option value="neighbourhood_cleansed_ΠΕΔΙΟ ΑΡΕΩΣ">
                  Pedion Areos
                </Option>
                <Option value="neighbourhood_cleansed_ΠΕΝΤΑΓΩΝΟ">
                  Pentagono
                </Option>
                <Option value="neighbourhood_cleansed_ΠΕΤΡΑΛΩΝΑ">
                  Petralona
                </Option>
                <Option value="neighbourhood_cleansed_ΠΛΑΤΕΙΑ ΑΜΕΡΙΚΗΣ">
                  Amerikis Square
                </Option>
                <Option value="neighbourhood_cleansed_ΠΛΑΤΕΙΑ ΑΤΤΙΚΗΣ">
                  Attikis Square
                </Option>
                <Option value="neighbourhood_cleansed_ΠΟΛΥΓΩΝΟ">
                  Poligono
                </Option>
                <Option value="neighbourhood_cleansed_ΠΡΟΜΠΟΝΑ">
                  Prompona
                </Option>
                <Option value="neighbourhood_cleansed_ΡΗΓΙΛΛΗΣ">Rigilis</Option>
                <Option value="neighbourhood_cleansed_ΡΙΖΟΥΠΟΛΗ">
                  Rizoupoli
                </Option>
                <Option value="neighbourhood_cleansed_ΣΕΠΟΛΙΑ">Sepolia</Option>
                <Option value="neighbourhood_cleansed_ΣΤΑΔΙΟ">Stadio</Option>
                <Option value="neighbourhood_cleansed_ΣΤΑΘΜΟΣ ΛΑΡΙΣΗΣ">
                  Larisis Station
                </Option>
              </Select>
            </Form.Item>
            ...
            <Form.Item label="Select amenities number">
              ...
              >
                <Option value="amenities_low">
                  Number of amenities less 27
                </Option>
                <Option value="amenities_medium">
                  Number of amenities 27-34
                </Option>
                <Option value="amenities_high">
                  Number of amenities more 34
                </Option>
              </Select>
            </Form.Item>
            ...
            <Form.Item label="Select property type">
              ...
              >
                ...
                <Option value="room_type_Entire home/apt">
                  Entire home/apt
                </Option>
